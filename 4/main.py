import pandas as pd
from methods.biseccion import metodo_biseccion as bs
from methods.newton_rhapson import new_rhapson_solve as nr
from methods.steffensen import metodo_steffensen as stf
from methods.secante import secante as sc
from methods.falsa_posicion import metodo_falsa_posicion as fp
from methods.NHO import hno
...
data = {
    ...
    "Resultado Aproximado": [result_bs[0], result_nr[0], result_stf[0], result_sc[0], result_fp[0], result_hno[0]],
    "Error": [result_bs[1], result_nr[1], result_stf[1], result_sc[1], result_fp[1], result_hno[1]],
    "Iteraciones": [result_bs[2], result_nr[2], result_stf[2], result_sc[2], result_fp[2], result_hno[2]],
